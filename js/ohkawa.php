...
<body>
<form action ="ohkawa.php"  method="GET">
            <input type="text" placeholder = "user_id" name="user_id" value="">
            <br>
            <input type="text" placeholder = "weight" name="weight_num" value="">
...
/* 
if(<?php isset( $UserInfo[7]['weight_num'])?>){ 
       weight7 = <?php echo $UserInfo[7]['weight_num']; ?>;
       else{ weight7 = 0;}
 }
 if(<?php isset( $UserInfo[6]['weight_num'])?>){ 
       weight6 = <?php echo $UserInfo[6]['weight_num']; ?>;
       else{ weight6 = 0;}
 }
 if(<?php isset( $UserInfo[5]['weight_num'])?>){ 
       weight5 = <?php echo $UserInfo[5]['weight_num']; ?>;
       else{ weight5 = 0;}
 }
 if(<?php isset( $UserInfo[4]['weight_num'])?>){ 
       weight4 = <?php echo $UserInfo[4]['weight_num']; ?>;
       else{ weight4 = 0;}
 }
 if(<?php isset( $UserInfo[3]['weight_num'])?>){ 
       weight3 = <?php echo $UserInfo[3]['weight_num']; ?>;
       else{ weight3 = 0;}
 }
if(isset(<?php $UserInfo[2]['weight_num']?>)){ 
       weight2 = <?php echo $UserInfo[2]['weight_num']; ?>;
       else{ weight2 = 0;}
 }
 if(isset(<?php $UserInfo[1]['weight_num']?>)){ 
       weight1 = <?php echo $UserInfo[1]['weight_num']; ?>;
       else{ weight1 = 0;}
 }*/
/*  if(isset($_POST['g'])){
  $player="グー";
  //$playerはのちのエコーでわかりやすくするため？
  if($n==0){
    $r=0;
  }
  else if($n==1){
...
<div id="my_chart" style="height: 500px"></div>
 ...
 document.write('<p>' + (weight0 - weight7) + '</p>');
</script>
<script type="text/javascript">
document.write('<p>' + (weight0 - weight7) + '</p>');
</script>
